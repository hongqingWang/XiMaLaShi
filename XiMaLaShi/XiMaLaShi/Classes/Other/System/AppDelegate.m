...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    QQTabBarController *rootVC = [QQTabBarController tabBarControllerWithAddChildVCsBlock:^(QQTabBarController *tabBarC) {
    ...
    QQTabBar *tabbar = (QQTabBar *)rootVC.tabBar;
